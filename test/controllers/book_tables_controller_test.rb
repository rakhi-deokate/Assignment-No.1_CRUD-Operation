...
class BookTablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create book_table" do
    assert_difference('BookTable.count') do
      post book_tables_url, params: { book_table: { Author_Date_of_Birth: @book_table.Author_Date_of_Birth, Author_Name: @book_table.Author_Name, Book_Title: @book_table.Book_Title, Published_year: @book_table.Published_year } }
    end
  ...
  test "should update book_table" do
    patch book_table_url(@book_table), params: { book_table: { Author_Date_of_Birth: @book_table.Author_Date_of_Birth, Author_Name: @book_table.Author_Name, Book_Title: @book_table.Book_Title, Published_year: @book_table.Published_year } }
